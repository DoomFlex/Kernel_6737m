...
static struct LCM_setting_table lcm_initialization_setting[] = {
  ...
  {0xB0,16,{0x00,0x0D,0x14,0x0D,0x10,0x05,0x02,0x08,0x08,0x1E,0x05,0x13,0x11,0xA3,0x29,0x18}},
  {0xB1,16,{0x00,0x0C,0x14,0x0C,0x10,0x05,0x03,0x08,0x07,0x20,0x05,0x13,0x11,0xA4,0x29,0x18}},
...
#if defined(BUILD_LK)
	printf("st7701_hsd50_jumei_fwvga %s,line=%d, id = 0x%x, buffer[0]=0x%08x,buffer[1]=0x%08x\n",__func__,__LINE__, device_id, buffer[0],buffer[1]);
#else
	printk("st7701_hsd50_jumei_fwvga %s,line=%d, id = 0x%x, buffer[0]=0x%08x,buffer[1]=0x%08x\n",__func__,__LINE__, device_id, buffer[0],buffer[1]);
#endif
...
// ---------------------------------------------------------------------------
LCM_DRIVER st7701_hsd50_jumei_fwvga_lcm_drv =
{
  .name			= "st7701_hsd50_jumei_fwvga",
