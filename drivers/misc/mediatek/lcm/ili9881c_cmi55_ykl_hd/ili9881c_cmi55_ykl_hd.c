...
{0x6F,1,{0x53}}, //6580 59              // reg vcl + VGH pumping ratio 3x VGL=-2x
...
{0x53,1,{0x43}},		//VCOM1
{0x55,1,{0x53}},		//VCOM2
{0x50,1,{0x75}},        	//VREG1OUT=V
{0x51,1,{0x85}},        	//VREG2OUT=V
...
LCM_DRIVER ili9881c_cmi55_ykl_hd_lcm_drv =
{
	.name			= "ili9881c_cmi55_ykl_hd",
