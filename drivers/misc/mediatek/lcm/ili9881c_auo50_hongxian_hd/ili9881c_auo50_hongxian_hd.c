...
static struct LCM_setting_table lcm_initialization_setting[] =
{
  ...
  {0x6E,1,{0x2b}}, //2d              //di_pwr_reg=0 for power mode 2A //VGH clamp 15V
  {0x6F,1,{0x33}}, //31              // reg vcl + pumping ratio VGH=3x VGL=-2.5x
  {0x3A,1,{0x24}},  //a4             //POWER SAVING
  {0x8D,1,{0x14}},  //14             //VGL clamp -12
  {0x87, 1, {0xBA}},
  {0x26, 1, {0x76}},
  {0xB2, 1, {0xD1}},
  ...
  {0x22,1,{0x0a}},//09		//BGR,1,0x GS
  {0x31, 1, {0x0b}},		//0b--Zig-ZaginversionType3
  {0x53,1,{0x4f}},		//VCOM1
  {0x55,1,{0x8f}},		//VCOM2
  {0x56,1,{0x00}},		//VCOM2
  {0x50,1,{0x96}},		//VREG1OUT=4.9V
  {0x51,1,{0x96}},		//VREG2OUT=-4.9V
  {0x60,1,{0x14}},               //SDT 
  //{0x61,1,{0x00}},               //CRT/////////////////
  //{0x62,1,{0x19}},               //EQT////////////
  //{0x63,1,{0x10}},               //PCT///////////////////
...
static void lcm_get_params(LCM_PARAMS *params)
{
  ...
  params->dsi.vertical_backporch                  = 24;// 20   1
...
LCM_DRIVER ili9881c_auo50_hongxian_hd_lcm_drv =
{
  .name			  = "ili9881c_auo50_hongxian_hd",
