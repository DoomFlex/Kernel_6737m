...
//    {0x08,1,{0x10}},                  //output SDA
    ...
    {0xAD,1,{0x31}},  // Gamma 247
    {0xAE,1,{0x2E}},  // Gamma 251
    {0xAF,1,{0x1F}},  // Gamma 255

    {0xC0,1,{0x02}},  // Gamma 0 	
    {0xC1,1,{0x0C}},  // Gamma 4	
    {0xC2,1,{0x16}},  // Gamma 8	
    {0xC3,1,{0x14}},  // Gamma 16	
    ...
    {0xCD,1,{0x27}},  // Gamma 247	
    {0xCE,1,{0x24}},  // Gamma 251		
    {0xCF,1,{0x1F}},  // Gamma 255	
...
static unsigned int lcm_compare_id(void)
{
    ...
    id = ((id_high << 16) | (id_midd << 8) | id_low)+adc_read_vol();
...
// ---------------------------------------------------------------------------
LCM_DRIVER ili9806e_cpt50_txd_fwvga_adc_lcm_drv =
{
  .name			= "ili9806e_cpt50_txd_fwvga_adc",
