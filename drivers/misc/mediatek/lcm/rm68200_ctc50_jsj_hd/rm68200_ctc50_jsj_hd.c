...
static unsigned int lcm_compare_id(void)
{
    ...
    id = (id_high<<8) | id_low;
#if defined(BUILD_LK)
    printf("%s, [rm68200_boe50_jsj_hd]  buffer[0] = [0x%x] buffer[2] = [0x%x] ID = [0x%x]\n",__func__, buffer[0], buffer[1], id);
#else
    printk("%s, [rm68200_boe50_jsj_hd]  buffer[0] = [0x%x] buffer[2] = [0x%x] ID = [0x%x]\n",__func__, buffer[0], buffer[1], id);
#endif
    return ((LCM_RM68200_ID == id)? 1 : 0);
}

LCM_DRIVER rm68200_ctc50_jsj_hd_lcm_drv =
{
    .name = "rm68200_ctc50_jsj_hd",
