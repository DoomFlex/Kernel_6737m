...
typedef enum tagDTS_GPIO_STATE {
	...
	DTS_GPIO_STATE_TE_MODE_TE,          /* mode_te_te */
        DTS_GPIO_STATE_RST_OUT0_GPIO,
        DTS_GPIO_STATE_RST_OUT1_GPIO,
        DTS_GPIO_STATE_BIAS_ENP0_GPIO,
        DTS_GPIO_STATE_BIAS_ENP1_GPIO,
        DTS_GPIO_STATE_BIAS2_ENP0_GPIO,
        DTS_GPIO_STATE_BIAS2_ENP1_GPIO,
