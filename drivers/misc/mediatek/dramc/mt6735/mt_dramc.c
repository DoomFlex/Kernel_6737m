...
void pmic_HQA_Voltage_adjust(int nAdjust)
{
	...
	case 3:		/*LVcLVm*/
		...
		pmic_config_interface(MT6328_VCORE1_CON11, 0x4B, 0x7F, 0);	/* 1.070V */
		pmic_config_interface(MT6328_VCORE1_CON12, 0x4B, 0x7F, 0);	/* 1.070V */
/* Vanzo:wuchuanrong on: Tue, 06 Dec 2016 15:43:52 +0800
 * TODO: pass pressure test for MT6735/MT6735M
        pmic_config_interface(MT6328_SLDO_ANA_CON1, 0x05, 0xF, 8);	// -1.00V (1.14V)
 */
#if defined(CONFIG_ARCH_MT6735) || defined(CONFIG_ARCH_MT6735M)
        pmic_config_interface(MT6328_SLDO_ANA_CON1, 0x02, 0xF, 8);	/* -0.04V (1.20V) */
#else
        pmic_config_interface(MT6328_SLDO_ANA_CON1, 0x05, 0xF, 8);	/* -1.00V (1.14V) */
#endif
...
/* Vanzo:wuchuanrong on: Tue, 06 Dec 2016 15:43:52 +0800
 * TODO: pass pressure test for MT6735/MT6735M
        pmic_config_interface(MT6328_SLDO_ANA_CON1, 0x01, 0xF, 8);	// -0.02V (1.22)
 */
#if defined(CONFIG_ARCH_MT6735) || defined(CONFIG_ARCH_MT6735M)
        pmic_config_interface(MT6328_SLDO_ANA_CON1, 0x0F, 0xF, 8);	/* +0.02V (1.26V) */
#else
