...
/*---------------------------------------------------------------------------------------*/
static DRIVER_ATTR(als,     0664, ltr579_show_als,		NULL);
static DRIVER_ATTR(ps,      0664, ltr579_show_ps,		NULL);
static DRIVER_ATTR(config,  0664, ltr579_show_config,	ltr579_store_config);
static DRIVER_ATTR(alslv,   0664, ltr579_show_alslv,	ltr579_store_alslv);
static DRIVER_ATTR(alsval,  0664, ltr579_show_alsval,	ltr579_store_alsval);
static DRIVER_ATTR(trace,   0664, ltr579_show_trace,	ltr579_store_trace);
static DRIVER_ATTR(status,  0664, ltr579_show_status,	NULL);
static DRIVER_ATTR(send,    0664, ltr579_show_send,	ltr579_store_send);
static DRIVER_ATTR(recv,    0664, ltr579_show_recv,	ltr579_store_recv);
static DRIVER_ATTR(reg,     0664, ltr579_show_reg,		NULL);
/*----------------------------------------------------------------------------*/
