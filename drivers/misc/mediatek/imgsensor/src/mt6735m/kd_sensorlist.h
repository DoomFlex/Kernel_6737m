...
UINT32 S5K4H5YC_MIPI_RAW_2LANE_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
/*HI*/
...
/*OV (OmniVision)*/
    ...
    {OV5675SUBMIPI_SENSOR_ID, SENSOR_DRVNAME_OV5675SUB_MIPI_RAW, OV5675SUB_MIPI_RAW_SensorInit},
#endif
...
/*S5K*/
    ...
    {S5K3H5XASUB_SENSOR_ID, SENSOR_DRVNAME_S5K3H5XASUB_MIPI_RAW, S5K3H5XASUB_MIPI_RAW_SensorInit},
#endif
#if defined(S5K4H8_MIPI_RAW)
    {S5K4H8_SENSOR_ID, SENSOR_DRVNAME_S5K4H8_MIPI_RAW, S5K4H8_MIPI_RAW_SensorInit},
#endif
#if defined(S5K4H5YC_MIPI_RAW_2LANE)
	{S5K4H5YC_2LANE_SENSOR_ID, SENSOR_DRVNAME_S5K4H5YC_MIPI_RAW_2LANE, S5K4H5YC_MIPI_RAW_2LANE_SensorInit},
#endif
/*HI*/
...
#endif
#if defined(GC8003MIPI_RAW)
	{GC8003MIPI_SENSOR_ID, SENSOR_DRVNAME_GC8003_MIPI_RAW, GC8003MIPI_RAW_SensorInit},
#endif
#if defined(GC13003_MIPI_RAW)
	{GC13003MIPI_SENSOR_ID, SENSOR_DRVNAME_GC13003MIPI_RAW, GC13003MIPI_RAW_SensorInit},
#endif
/*SP*/
