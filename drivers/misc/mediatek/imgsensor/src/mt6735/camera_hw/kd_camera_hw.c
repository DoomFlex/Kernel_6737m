...
#define CUST_AVDD AVDD - AVDD  /*0*/
#define CUST_DVDD DVDD - AVDD   /*1*/
#define CUST_DOVDD DOVDD - AVDD /*2*/
#define CUST_AFVDD AFVDD - AVDD /*3*/
#define CUST_SUB_AVDD SUB_AVDD - AVDD /*4*/
#define CUST_SUB_DVDD SUB_DVDD - AVDD   /*5*/
#define CUST_SUB_DOVDD SUB_DOVDD - AVDD /*6*/
#define CUST_MAIN2_AVDD MAIN2_AVDD - AVDD /*7*/
#define CUST_MAIN2_DVDD MAIN2_DVDD - AVDD   /*8*/
#define CUST_MAIN2_DOVDD MAIN2_DVDD - AVDD  /*9*/
...
{   
...
#endif
#if defined(S5K3M2SUNNY_MIPI_RAW)
  {SENSOR_DRVNAME_S5K3M2SUNNY_MIPI_RAW,
    {
      {SensorMCLK, Vol_High, 0},
      {DOVDD, Vol_1800, 0},
      {AVDD, Vol_2800, 0},
  ...
  {SENSOR_DRVNAME_OV8858SUNNY_MIPI_RAW,
    {
      {SensorMCLK, Vol_High, 0},
      {PDN, Vol_Low, 0},
      {RST, Vol_Low, 0},
...
#endif
#if defined(OV12830SUB_MIPI_RAW)
  {SENSOR_DRVNAME_OV12830SUB_MIPI_RAW,
    {
      {SensorMCLK,Vol_High, 0},
      {PDN,	Vol_Low, 0},
      {RST,	Vol_Low, 0}, 
