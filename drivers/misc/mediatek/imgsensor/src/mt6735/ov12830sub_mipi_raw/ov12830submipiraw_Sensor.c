...
#include "ov12830submipiraw_Sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "OV12830SUB_camera_sensor"
#define LOG_1 LOG_INF("OV12830SUB,MIPI 4LANE\n")
...
int ov12830sub_chip_ver = OV12830SUB_R1A;


static imgsensor_info_struct imgsensor_info = {
    .sensor_id = OV12830SUB_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
static void set_mirror_flip(kal_uint8 image_mirror)
{
    ...
    switch (image_mirror) {
				...
				case IMAGE_H_MIRROR:
					...
					break;
				case IMAGE_V_MIRROR:
                        write_cmos_sensor(0x3820,((read_cmos_sensor(0x3820) | 0x42) & 0xFF));
...
static kal_uint32 open(void)
{
    ...
    if (imgsensor_info.sensor_id != sensor_id)
		...
		{
				LOG_INF("----R1A---- \n");
				ov12830sub_chip_ver = OV12830SUB_R1A;
		}else if((read_cmos_sensor(0x302a))==0xb2)
		{
				LOG_INF("----R2A---- \n");
				ov12830sub_chip_ver = OV12830SUB_R2A;
		}
...
UINT32 OV12830SUB_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
