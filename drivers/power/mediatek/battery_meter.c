...
#ifdef VANZO_MULTI_BAT_PROFILE_BY_GPIO
#define MTK_GET_BATTERY_ID_BY_GPIO 1
#define MTK_MULTI_BAT_PROFILE_SUPPORT 1
#endif
...
void fgauge_get_profile_id(void)
{
  ...
  mt_set_gpio_mode(GPIO_BAT_ID, 0);
  mt_set_gpio_dir(GPIO_BAT_ID, GPIO_DIR_IN);
 // mt_set_gpio_pull_enable(GPIO_BAT_ID, GPIO_PULL_DISABLE);
  g_fg_battery_id = mt_get_gpio_in(GPIO_BAT_ID);

	bm_print(BM_LOG_CRTI, "[fgauge_get_profile_id]Battery id (%d)\n", g_fg_battery_id);
	battery_log(BAT_LOG_CRTI, "battery id is:%d\n",g_fg_battery_id);
}
#else
void fgauge_get_profile_id(void)
{
...
signed int fgauge_get_Q_max(signed short temperature)
{
    ...
    if (g_fg_battery_id == 0)
    {
      if (temperature <= TEMPERATURE_T1) {
        low_temperature = (-10);
        low_Q_max = Q_MAX_NEG_10;    //g_Q_MAX_NEG_10[g_fg_battery_id];
        high_temperature = TEMPERATURE_T1;
        high_Q_max = Q_MAX_POS_0;    //g_Q_MAX_POS_0[g_fg_battery_id];
        ...
        low_Q_max = Q_MAX_POS_0;     //g_Q_MAX_POS_0[g_fg_battery_id];
        high_temperature = TEMPERATURE_T2;
        high_Q_max = Q_MAX_POS_25;   //g_Q_MAX_POS_25[g_fg_battery_id];
        ...
        low_Q_max = Q_MAX_POS_25;  //g_Q_MAX_POS_25[g_fg_battery_id];
        high_temperature = TEMPERATURE_T3;
        high_Q_max = Q_MAX_POS_50;//g_Q_MAX_POS_50[g_fg_battery_id];
    ...
    else if (g_fg_battery_id == 1)
    {
      if (temperature <= TEMPERATURE_T1) {
        low_temperature = (-10);
        low_Q_max = G_Q_MAX_NEG_10_ID1;   //g_Q_MAX_NEG_10[g_fg_battery_id];
        high_temperature = TEMPERATURE_T1;
        high_Q_max = G_Q_MAX_POS_0_ID1;   //g_Q_MAX_POS_0[g_fg_battery_id];
        ...
        low_temperature = TEMPERATURE_T1;
        low_Q_max = G_Q_MAX_POS_0_ID1;   //g_Q_MAX_POS_0[g_fg_battery_id];
        high_temperature = TEMPERATURE_T2;
        high_Q_max = G_Q_MAX_POS_25_ID1;//g_Q_MAX_POS_25[g_fg_battery_id];
        ...
        low_temperature = TEMPERATURE_T2;
        low_Q_max = G_Q_MAX_POS_25_ID1;//g_Q_MAX_POS_25[g_fg_battery_id];
        high_temperature = TEMPERATURE_T3;
        high_Q_max = G_Q_MAX_POS_50_ID1;//g_Q_MAX_POS_50[g_fg_battery_id];
...
signed int fgauge_get_Q_max_high_current(signed short temperature)
{
   ...
   if (g_fg_battery_id == 0)
   {
	if (temperature <= TEMPERATURE_T1) {
		low_temperature = (-10);
		low_Q_max = Q_MAX_NEG_10_H_CURRENT;//g_Q_MAX_NEG_10_H_CURRENT[g_fg_battery_id];
		high_temperature = TEMPERATURE_T1;
		high_Q_max = Q_MAX_POS_0_H_CURRENT;//g_Q_MAX_POS_0_H_CURRENT[g_fg_battery_id];
		...
		low_temperature = TEMPERATURE_T1;
		low_Q_max = Q_MAX_POS_0_H_CURRENT;//g_Q_MAX_POS_0_H_CURRENT[g_fg_battery_id];
		high_temperature = TEMPERATURE_T2;
		high_Q_max = Q_MAX_POS_25_H_CURRENT;//g_Q_MAX_POS_25_H_CURRENT[g_fg_battery_id];
		...
		low_temperature = TEMPERATURE_T2;
		low_Q_max = Q_MAX_POS_25_H_CURRENT;//g_Q_MAX_POS_25_H_CURRENT[g_fg_battery_id];
		high_temperature = TEMPERATURE_T3;
		high_Q_max = Q_MAX_POS_50_H_CURRENT;//g_Q_MAX_POS_50_H_CURRENT[g_fg_battery_id];
   ...
   else if (g_fg_battery_id == 1)
   {
	if (temperature <= TEMPERATURE_T1) {
		low_temperature = (-10);
		low_Q_max = G_Q_MAX_NEG_10_H_CURRENT_ID1;//g_Q_MAX_NEG_10_H_CURRENT[g_fg_battery_id];
		high_temperature = TEMPERATURE_T1;
		high_Q_max = G_Q_MAX_POS_0_H_CURRENT_ID1;//g_Q_MAX_POS_0_H_CURRENT[g_fg_battery_id];
		...
		low_temperature = TEMPERATURE_T1;
		low_Q_max = G_Q_MAX_POS_0_H_CURRENT_ID1;//g_Q_MAX_POS_0_H_CURRENT[g_fg_battery_id];
		high_temperature = TEMPERATURE_T2;
		high_Q_max = G_Q_MAX_POS_25_H_CURRENT_ID1;//g_Q_MAX_POS_25_H_CURRENT[g_fg_battery_id];
      ...
      low_temperature = TEMPERATURE_T2;
      low_Q_max = G_Q_MAX_POS_25_H_CURRENT_ID1;//g_Q_MAX_POS_25_H_CURRENT[g_fg_battery_id];
      high_temperature = TEMPERATURE_T3;
      high_Q_max = G_Q_MAX_POS_50_H_CURRENT_ID1;//g_Q_MAX_POS_50_H_CURRENT[g_fg_battery_id];
...
BATTERY_PROFILE_STRUCT_P fgauge_get_profile(unsigned int temperature)
{
  if (g_fg_battery_id == 0)
	...
	default:
		...
		switch (temperature) {
			  case TEMPERATURE_T0: 
				return &battery_profile_id1_t0[0];
				
			  case TEMPERATURE_T1:
			   
				return &battery_profile_id1_t1[0];
				/*break;*/
			  case TEMPERATURE_T2:
			  
				return &battery_profile_id1_t2[0];
				/*break;*/
			  case TEMPERATURE_T3:
			  
				return &battery_profile_id1_t3[0];
				/*break;*/
			  case TEMPERATURE_T:
				
				return &battery_profile_id1_temperature[0];
				/*break;*/
			default:
				return NULL;
				/*break;*/
	...
	default:
		...
		switch (temperature) {
			  ...
			  case TEMPERATURE_T0: 
				...
				return &r_profile_id1_t0[0];
				/*break;*/
			  case TEMPERATURE_T1: 
			 
				return &r_profile_id1_t1[0];
				/*break;*/
			  case TEMPERATURE_T2: 
			  
				return &r_profile_id1_t2[0];
				/*break;*/
			  case TEMPERATURE_T3: 
			   
				return &r_profile_id1_t3[0];
				/*break;*/
			  case TEMPERATURE_T: 
				
				return &r_profile_id1_temperature[0];
...
/* ------------------------------------------------------------------------------------------- */
#ifdef MTK_MULTI_BAT_PROFILE_SUPPORT
static ssize_t show_bat_id(struct device *dev,struct device_attribute *attr,const char *buf)
{
    bm_print(BM_LOG_CRTI,"[FG] bat_id : %d\n",g_fg_battery_id);
    return sprintf(buf,"%d\n",g_fg_battery_id);
}
