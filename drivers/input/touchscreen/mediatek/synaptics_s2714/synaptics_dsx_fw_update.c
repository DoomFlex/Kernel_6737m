...
static int fwu_start_write_config(void)
{
	...
	printk("%s: Start of write config process\n", __func__);
	...
	printk("%s: End of write config process\n", __func__);
