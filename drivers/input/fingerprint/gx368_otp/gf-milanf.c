...
static int fingerprint_get_gpio_info(struct platform_device *pdev)
{
    ...
    if (IS_ERR(ldo_lv8_off))
    {
        ...
        dev_err(&pdev->dev, "fwq Cannot find nasri_fingerprint pinctrl fp_ldo1v8_off!\n");
        return ret;
    }
    ...
    if (IS_ERR(ldo_1v8_on))
    {
        ...
        dev_err(&pdev->dev, "fwq Cannot find nasri_fingerprint pinctrl fp_ldo1v8_on!\n");
        return ret;
    }
    ...
    if (IS_ERR(ldo_3v3_off))
    {
        ...
        dev_err(&pdev->dev, "fwq Cannot find nasri_fingerprint pinctrl fp_ldo3v3_off!\n");
        return ret;
    }
    ...
    if (IS_ERR(ldo_3v3_on))
    {
        ...
        dev_err(&pdev->dev, "fwq Cannot find nasri_fingerprint pinctrl fp_ldo3v3_on!\n");
        return ret;
    }    
